...
train_dataset = ld.ImageFolder_pair(img_dir_path, annot_dir_name, ld.get_transform(train=True))
val_dataset = ld.ImageFolder_pair(img_dir_path, annot_dir_name, ld.get_transform(train=False))
